...
# Strictness thresholds for violations
VIOLATION_THRESHOLD: dict[str, float] = {"low": 0.85, "medium": 0.75, "high": 0.70}
...
def strictness_bias(
    ...
    threshold = VIOLATION_THRESHOLD.get(strictness, 0.75)
    for obs in observations:
